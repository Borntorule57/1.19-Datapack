...
summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:ender_pearl",Count:1b},Tags:["wp.fake_spawn_item"],PickupDelay:-32767s}
...
execute as @e[tag=wp.fake_spawn_item,limit=1,sort=nearest] run function warppad:creation/_anonymous0/_anonymous0
tp @s ~ -1000.0 ~
kill @s
