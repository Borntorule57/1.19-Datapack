data modify entity @s data.Private set value 1b
...
title @a[tag=wp.displaying_gui,tag=wp.mod_thrower] actionbar {"text":"Warp Pad Stream set to Private for ","color":"dark_purple","extra":[{"selector":"@p[tag=wp.mod_thrower]"}]}
