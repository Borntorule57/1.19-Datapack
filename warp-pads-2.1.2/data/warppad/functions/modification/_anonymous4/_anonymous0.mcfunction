...
data modify entity @s data.Color set value "cyan"
...
title @a[tag=wp.displaying_gui,tag=wp.mod_thrower] actionbar {"text":"Warp Pad Color set to ","color":"dark_purple","extra":["Cyan"]}
